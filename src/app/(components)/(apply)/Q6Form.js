      ...
      <div className="flex flex-col md:flex-row w-full justify-between">
        <div className="flex flex-col md:w-[40%] pt-10 justify-between">
          ...
          <span className="text-[#8A9FB1]">
            * 디자이너 직군은 진행한 과제, 작업물이 담겨있는 포트폴리오를 필수로 받고있어요. <br />
            * 개발자 직군은 깃허브 링크 혹은 포트폴리오를 필수로 첨부해주세요.
             <br />* 파일은 50MB이내의 크기로 첨부해주세요. <br />
             * 파일은 .pdf, .png, .jpg, .jpeg로만 제출해주세요. <br />
            * 필수적인 파일을 제출하지 않을 시 불이익이 있을 수 있습니다.
          </span>
        </div>
